...
/* NMapActivity implements OnMapStateChangeListener, OnMapViewTouchEventListener, NMapOverlayManager.OnCalloutOverlayListener {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        poiData.addPOIitem(127.0717071, 37.5430388, "우마이도 - 건대 인본 라멘 집", markerId, 0);
        poiData.endPOIdata();
   ...
   @Override
    ...
    public void onCalloutClick(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item)
    {
        ...
        Toast.makeText(NewActivity.this, "onCalloutClick: " + item.getTitle(), Toast.LENGTH_LONG).show();
    }
